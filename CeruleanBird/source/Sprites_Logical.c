...
*		@arg	创建成功返回 精灵地址
*/
Sprites_t* Sprites_ObjectCreate(int value,double posRow,double posCol,unsigned char defaultAnimationChainIndex,\
	...
	//动画树配置
	sprites->SpritesBase.AnimMoudle.value = value;
	...
	sprites->BehaviorMoudle.IT_flag = 0;//中标志位关闭
...
*		@arg	创建成功返回 精灵地址
*/
SpritesStatic_t* SpritesStatic_ObjectCreate(int value,double posRow,double posCol,unsigned char defaultAnimationChainIndex,\
	double moveSpeed,int map_value){
		//分配内存
